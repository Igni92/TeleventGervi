...
/**
 * GET /api/meteo?q=<ville> → { ok, city, temp, code, wind }
 *
 * Météo courante d'une ZONE (ville), pour le bandeau d'accueil (MeteoBar).
 * Source : Open-Meteo (gratuit, sans clé). Deux appels enchaînés :
 *   1. géocodage de la ville → latitude/longitude ;
 *   2. relevé courant (température, code temps WMO, vent).
