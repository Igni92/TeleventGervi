          ...
          {runs.map((r) => (
            <div key={r.id} className="rounded-lg border border-border bg-card/50 px-3 py-2.5">
              ...
              <div className="mt-1.5 flex items-center gap-3 flex-wrap text-[12.5px] text-muted-foreground">
                ...
                {r.sapExitDocNum != null && <span>Sortie SAP <b className="text-foreground">n° {r.sapExitDocNum}</b></span>}
                {r.sapEntryDocNum != null && <span>Entrée SAP <b className="text-foreground">n° {r.sapEntryDocNum}</b></span>}
