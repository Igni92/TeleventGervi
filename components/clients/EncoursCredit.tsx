...
/**
 * Encours / limite de crédit du client (C6).
 *
 * Lit /api/sap/clients/[id]/credit (miroir SapBusinessPartner — SAP
 * CreditLimit / CurrentAccountBalance / Frozen). Affiche :
 *   - limite de crédit, encours actuel (solde du compte), % utilisé (barre)
 *   - badge "Compte gelé" si Frozen
 *   - badge "Encours dépassé" si encours > limite
 *
 * Le parent ne monte cet encart QUE si available=true (cf. la fiche client) :
 * pas de bruit visuel quand la donnée SAP est absente.
 */
...
/** État partagé : permet à la fiche de ne pas réserver d'espace si pas de donnée. */
