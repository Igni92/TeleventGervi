 ...
 *  chargement, et pas d'animation d'entrée JS. Le libellé ondule (TextShimmerWave)
 *  — teinte marque via surcharge de `--shimmer-hi`. */
  ...
  return (
    <div className="flex items-center gap-4 rounded-2xl border border-border bg-card px-6 py-4 shadow-2xl">
      ...
      <div className="min-w-0">
        <TextShimmerWave
          duration={1.1}
          className="text-[13px] font-semibold leading-tight [--shimmer-hi:#a16207] dark:[--shimmer-hi:#fbbf24]"
        >
