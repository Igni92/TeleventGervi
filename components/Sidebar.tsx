...
import {
  ...
  CalendarDays, Building2, Wallet, Boxes, Target, Archive,
} from "lucide-react";
...
export function Sidebar() {
  ...
  return (
    ...
    <motion.aside
      ...
      className="app-sidebar sticky top-0 h-screen shrink-0 z-50 hidden md:flex touch:!hidden flex-col bg-[#0b1018] border-r border-white/[0.07] overflow-hidden"
    >
