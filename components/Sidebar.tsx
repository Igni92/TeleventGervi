...
export function Sidebar() {
  ...
  return (
    ...
    <motion.aside
      ...
      className="sticky top-0 h-screen shrink-0 z-50 hidden md:flex [@media(pointer:coarse)]:!hidden flex-col bg-[#0b1018] border-r border-white/[0.07] overflow-hidden"
    >
